...
public class Constants {
    ...
    public final static boolean FOLDING_INVERTED = false;
    public final static double MIN_PROXIMITY = 0;
    public final static double AXIS_DIAMETER = (1.27) / 100;
    public final static double INTAKE_ARC = (AXIS_DIAMETER * Math.PI);
